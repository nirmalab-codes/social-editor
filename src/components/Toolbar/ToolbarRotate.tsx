...
const ToolbarRotate: React.FC = observer(() => {
    ...
    <>
      <div className="toolbar__content">
        <div className="toolbar__options toolbar__options_one-col">
          ...
          <div
            className={`toolbar__option ${canvasStore.flipX ? "toolbar__option_active" : ""
              }`}
          ...
          <div
            className={`toolbar__option ${canvasStore.flipY ? "toolbar__option_active" : ""
              }`}
